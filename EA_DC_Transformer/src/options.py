...
class Options(object):
    ...
    def __init__(self):
        ...
        # self.parser.add_argument('--name', default='',
        ...
        self.parser.add_argument('--data',  type=str,
                                 help="Which data should be processed.")
        self.parser.add_argument('--runtype',  choices={'ablation', 'ea', 'encoder', 'concat'},
                                 help="Which data should be processed.")
        ...
        # Model
        self.parser.add_argument('--model', choices={"transformer", "LINEAR", "LSTM", "GRU", "SimpleConv", "CausalConv", "EACausalConv"}, default="transformer",
                                 help="Model class")
        ...
        self.parser.add_argument('--dilation', type=int, default=1,
                                 help='Spacing between kernel elements for SimpleConv')
        self.parser.add_argument('--isdilated', choices={"TRUE", "FALSE"}, default="TRUE",
                                 help='whether CausalConv is dilated or not')        
        self.parser.add_argument('--out_channel', type=int, default=64,
        ...
        self.parser.add_argument('--alpha', type=float, default=0.3,
                                 help='ratio to be used internally in EA augment encoder')
        self.parser.add_argument('--beta', type=float, default=0.7,
                                 help='ratio to be used internally in EA augment encoder')
        self.parser.add_argument('--k', type=float, default=0.125,
                                 help='ratio to be used internally in EA augment encoder')
        self.parser.add_argument('--v', type=float, default=0.125,
                                 help='ratio to be used internally in EA augment encoder')
